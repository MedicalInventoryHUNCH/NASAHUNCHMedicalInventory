...
'''This Version of face_rec is used to present and doesn't feature the live face recognition
Instead it uses a still image to compare to the reference images'''
...
def capture_and_compare(cap, known_faces):
    ...
    try:
        ...
        current_face_encoding = face_recognition.face_encodings(face_used)[0]
